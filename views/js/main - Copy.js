...
function updatePositions() {
  ...
  var items = document.getElementsByClassName('mover'); //collects all mover elements total of 24
  
  //var scrollTop = document.documentElement.scrollTop || document.body.scrollTop;//measures distance
  //var phase = Math.sin((scrollTop / 1250) + (i % 5));
  //var visibleItems = items;
  //console.log(visibleItems);
  //visibleItems[i].style.left = items[i].basicLeft + 100 * phase
  
//   visibleItems.forEach(function(element) {
//       console.log("left: " + visibleItems[element] + element.style.left);
//       var check = element.style.left;
//       //if (items[element].left > 0 && items[element].left < window.innerWidth)
//       //console.log(true);
//       if (check > 0) {
//         console.log("greater than zero!");
//         var visibleItems = visibleItems.push(element);
//         console.log("Visible: " + visibleItems);
//       }
//   });

   //make a phase array as only ever 5 different numbers:
...
// window.onresize = clearUp;

// function clearUp() {
//   var top = document.getElementById("movingPizzas1");
//   var nested = document.getElementsByClassName("mover");
...
document.addEventListener('DOMContentLoaded', function (){  
  ...
  for (var i = 0; i < 24; i++) {//i changed from 200 to 24, limits number of rows to three, see .top property below
    var elem = document.createElement('img');
    elem.className = 'mover';
    elem.src = "images/pizza.png";
    elem.style.height = "100px";
    elem.style.width = "73.333px";
    elem.basicLeft = (i % cols) * s;//starts pizza to initial left positon on loading page
    elem.style.top = (Math.floor(i / cols) * s) + 'px';//gives 24/8 = 3 rows: 0px 256px 512px
    //console.log("elem.style.top: " + elem.style.top);
    //possible if window.innerWidth
    //if (elem.basicLeft < window.innerWidth) {
      document.querySelector("#movingPizzas1").appendChild(elem);
    //} 
// would have to recall updatePositions on resizing the window
  }
  updatePositions();
});
